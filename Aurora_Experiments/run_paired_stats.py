...
def main(argv=None):
    ...
    pair_rows = compare_pairs(pt, lead=a.lead, family=a.family,
                              blocks=(1, 2, 3), n_boot=a.n_boot)
    _write(os.path.join(a.outdir, "harness_results_paired.csv"), FIELDS, pair_rows)
    rem_rows = damage_removed(pt, lead=a.lead, family=a.family,
                              blocks=(1, 2, 3), n_boot=a.n_boot)
    _write(os.path.join(a.outdir, "harness_damage_removed.csv"), REMOVED_FIELDS, rem_rows)
