""" Aurora W4 ablation anaysis (one group quantised per ablation)
"""
import torch
...
config = UIntXWeightOnlyConfig(dtype=torch.uint4, group_size=64)   # W4 weight-only (W4A32), as in aurora_inference_W4
...
out_dir = f"ablation_W4_medium_sampled_{YEAR}_{PER_MONTH}pm"
