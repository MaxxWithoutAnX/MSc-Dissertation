...
config = Int8DynamicActivationInt8WeightConfig()                 # W8A8 (int8 weight + dynamic int8 activation), as in aurora_inference_W8A8
...
out_dir = f"ablation_W8A8_medium_sampled_{YEAR}_{PER_MONTH}pm"
