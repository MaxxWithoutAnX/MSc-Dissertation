""" Aurora full precision forward run
"""
print('hi', flush=True)
...
#Add model quantisation here in the future
quantisation_scheme = ""
...
out_dir = f"results{quantisation_scheme}_sampled_{YEAR}_{PER_MONTH}pm_fp32_Autocast"
