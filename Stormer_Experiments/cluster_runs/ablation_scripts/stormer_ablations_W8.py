""" Stormer W8 ablation anaysis (one group quantised per ablation)
"""
print('hi', flush=True)
import os
import numpy as np
...
config = Int8WeightOnlyConfig()                    # W8 (int8 weight-only), as in stormer_inference_fullyear_W8
...
out_dir = f"ablation_W8_medium_fullyear_{len(indices)}i"
